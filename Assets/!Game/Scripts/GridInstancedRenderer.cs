...
public class GridInstancedRenderer : MonoBehaviour
{
    ...
    //     int batchCount = Mathf.CeilToInt(total / (float)MaxBatchSize);
    //
    ...
    //     {
    //         int count = Mathf.Min(MaxBatchSize, total - index);
    ...
    //             batch[i] = Matrix4x4.TRS(pos, rotation, scale);
    //         }
    //
    //         _batches[b] = batch;
    //     }
